...
<table width="800" border="1" bordercolor="#336699" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
  <!--DWLayoutTable-->
  <tr>
    <td width="186" height="245" valign="top"><table width="184" border="0" bordercolor="#336699" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
      <!--DWLayoutTable-->
      <tr>
        <td width="184" align="left" valign="baseline"><jsp:include page="login1.jsp" flush="true"/></td>
      </tr>
    ...
    <td width="590" rowspan="5" align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td width="200" height="30" align="center" bgcolor="#336699"><span class="STYLE2">&nbsp;搜索结果</span></td>
