          ...
          <td width="602" valign="top"><table width="100%"  border="0" bordercolor="#336699" style="border-collapse:collapse" cellspacing="0" cellpadding="0">
            <!--DWLayoutTable-->
                      ...
                      <tr>
                        ...
                        <td width="18%" height="37" align="center" bgcolor="#336699" class="STYLE2" ><img src="../../ncp/image/payment_ok.jpg" /></td>
                        <td width="35%" align="center" bgcolor="#336699" class="STYLE2" > 订单详细信息</td>
                        <td height="37" align="center" bgcolor="#336699" class="STYLE2" ><!--DWLayoutEmptyCell-->&nbsp;</td>
                        <td width="2%">&nbsp;</td>
                      </tr>
                      <tr>
...
<table width="95%" height="83" border="0" bordercolor="#336699" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
...
<table width="100%" height="83" border="0" bordercolor="#336699" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
      <tr align="center" valign="middle">
        <td height="10" colspan="3"><hr size="1" color="#336699" width="560"></td>
        </tr>
      <tr align="center" valign="middle">
